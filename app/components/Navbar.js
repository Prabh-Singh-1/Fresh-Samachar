                ...
                <div className="max-w-screen-xl flex flex-row gap-2 flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex md:order-2 gap-1">
                        ...
                        <div className={`relative ${searchtoggle ? "" : "hidden"} md:block`}>
                            <button onClick={() => { handleChange() }} className="cursor-pointer absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                <svg className="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z" />
                                </svg>
                                <span className="sr-only">Search icon</span>
                            </button>
                            <input type="text" id="search-navbar"  onKeyDown={(e)=>{if(e.key=="Enter"){handleChange()}}}  className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." value={search} onChange={(e) => { setSearch(e.target.value) }} onBlur={handleBlur} />
                        </div>
                    ...
                    <div className={`items-center justify-between ${togglenav ? "" : "hidden"} w-full md:flex md:w-auto md:order-1`} id="navbar-search" >
                        <div className="relative mt-3 md:hidden">
                            ...
                            <input type="text" id="search-navbar"  onKeyDown={()=>{handleChange()}}  className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." />
                        </div>
