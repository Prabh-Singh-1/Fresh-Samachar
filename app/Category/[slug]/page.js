...
export default function Page() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                const response = await fetch(`https://fresh-samachar.vercel.app/api/news?query=${decodedSlug}`);
        ...
        <>
            <div className="min-h-screen bg-gray-100">
                <main className="container mx-auto px-4 py-6">
                    <h1 className="text-3xl font-semibold mb-4 text-center">Blogs for <span className="font-bold">{decodedSlug}</span></h1>
